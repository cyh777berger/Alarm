...
SOPCINFO_FILE := D:/alarm/qsys/hardware/Alarm.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0xc10b0
SOPC_SYSID_FLAG += --sidp=0xc10b0
ELF_PATCH_FLAG  += --sidp 0xc10b0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1745495106
SOPC_SYSID_FLAG += --timestamp=1745495106
ELF_PATCH_FLAG  += --timestamp 1745495106
